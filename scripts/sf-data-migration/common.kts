...
val PROMOTION_METADATA = EntityMetadata(
    ...
    fields = listOf(
        ...
        FieldMapping("DKRetail__AccId__c", "dk_account_sfid"),
...
val NOTICE_METADATA = EntityMetadata(
    ...
    fields = listOf(
        ...
        FieldMapping("DKRetail__EduCategory__c", "edu_category"),
...
val TEAM_MEMBER_SCHEDULE_METADATA = EntityMetadata(
    ...
    fields = listOf(
        ...
        FieldMapping("WorkingCategory4__c", "working_category4"),
        FieldMapping("AccountId__c", "account_sfid"),
        FieldMapping("DKRetail__AccountId__c", "dk_account_sfid"),
...
val UPLOAD_FILE_METADATA = EntityMetadata(
    ...
    fields = listOf(
        ...
        // SF Object__c (= 부모 SObject API 명) 는 원본 그대로 object_type 에 적재.
        // parent_type 은 Stage2 가 object_type 기준으로 파생 (record_sfid → parent_id 동일 패턴).
        ...
        FieldMapping("IsDeleted", "is_deleted", isString = false),
        FieldMapping("CreatedDate", "created_at", nullable = false, isString = false),
        // SF LastModifiedDate → updated_at (네이티브 COPY 라 JPA auditing 미작동, 명시 매핑 필요).
        FieldMapping("LastModifiedDate", "updated_at", nullable = false, isString = false),
        FieldMapping("OwnerId", "owner_sfid"),
        FieldMapping("CreatedById", "created_by_sfid"),
        FieldMapping("LastModifiedById", "last_modified_by_sfid")
...
val TARGET_SPECS: Map<String, TargetSpec> = mapOf(
    "Organization" to TargetSpec(ORGANIZATION_METADATA, "Org__c", "organizations.csv", "domain/org/organization/entity/Organization"),
    "Account"      to TargetSpec(ACCOUNT_METADATA, "Account", "accounts.csv", "domain/foundation/account/entity/Account"),
    "Product"      to TargetSpec(PRODUCT_METADATA, "DKRetail__Product__c", "products.csv", "domain/foundation/product/entity/Product"),
    "Promotion"    to TargetSpec(PROMOTION_METADATA, "DKRetail__Promotion__c", "promotions.csv", "domain/activity/promotion/entity/Promotion"),
    "Group"        to TargetSpec(GROUP_METADATA, "Group", "groups.csv", "domain/org/employee/entity/Group"),
    "Employee"     to TargetSpec(EMPLOYEE_METADATA, "DKRetail__Employee__c", "employees.csv", "domain/org/employee/entity/Employee"),
    ...
    "Notice"       to TargetSpec(NOTICE_METADATA, "DKRetail__Notice__c", "notices.csv", "domain/support/notice/entity/Notice"),
    // PermissionSetAssignment 은 SF SObject 와 backend 의 staging table 1:1 매핑 (자체 entity 없음) → verify 면제
    "AccountCategoryMaster" to TargetSpec(ACCOUNT_CATEGORY_MASTER_METADATA, "AccountCategoryMaster__c", "account_category_masters.csv", "domain/foundation/account/entity/AccountCategoryMaster"),
    "AgreementHistory" to TargetSpec(AGREEMENT_HISTORY_METADATA, "AgreementHistory__c", "agreement_historys.csv", "platform/common/entity/AgreementHistory"),
    "AgreementWord" to TargetSpec(AGREEMENT_WORD_METADATA, "AgreementWord__c", "agreement_words.csv", "domain/support/agreement/entity/AgreementWord"),
    "AlternativeHoliday" to TargetSpec(ALTERNATIVE_HOLIDAY_METADATA, "DKRetail__AlternativeHoliday__c", "alternative_holidays.csv", "domain/org/leave/entity/AlternativeHoliday"),
    "Appointment" to TargetSpec(APPOINTMENT_METADATA, "Appointment__c", "appointments.csv", "domain/activity/schedule/entity/Appointment"),
    "AttendanceLog" to TargetSpec(ATTENDANCE_LOG_METADATA, "DKRetail__CommuteLog__c", "attendance_logs.csv", "domain/activity/schedule/entity/AttendanceLog"),
    "AttendInfo" to TargetSpec(ATTEND_INFO_METADATA, "AttendInfo__c", "attend_infos.csv", "domain/activity/schedule/entity/AttendInfo"),
    "Claim" to TargetSpec(CLAIM_METADATA, "DKRetail__Claim__c", "claims.csv", "domain/activity/claim/entity/Claim"),
    "DisplayWorkSchedule" to TargetSpec(DISPLAY_WORK_SCHEDULE_METADATA, "DisplayWorkScheduleMaster__c", "display_work_schedules.csv", "domain/activity/schedule/entity/DisplayWorkSchedule"),
    "EmployeeInputCriteriaMaster" to TargetSpec(EMPLOYEE_INPUT_CRITERIA_MASTER_METADATA, "EmployeeInputCriteriaMaster__c", "employee_input_criteria_masters.csv", "domain/activity/schedule/entity/EmployeeInputCriteriaMaster"),
    "ErpOrder" to TargetSpec(ERP_ORDER_METADATA, "ERP_Order__c", "erp_orders.csv", "domain/activity/order/entity/ErpOrder"),
    "ErpOrderProduct" to TargetSpec(ERP_ORDER_PRODUCT_METADATA, "ERP_OrderProduct__c", "erp_order_products.csv", "domain/activity/order/entity/ErpOrderProduct"),
    "HolidayMaster" to TargetSpec(HOLIDAY_MASTER_METADATA, "HolidayMaster__c", "holiday_masters.csv", "domain/org/leave/entity/HolidayMaster"),
    "WorkingDayMaster" to TargetSpec(WORKING_DAY_MASTER_METADATA, "WorkingDayMaster__c", "working_day_masters.csv", "domain/sales/entity/WorkingDayMaster"),
    "InspectionTheme" to TargetSpec(INSPECTION_THEME_METADATA, "Theme__c", "inspection_themes.csv", "domain/activity/inspection/entity/InspectionTheme"),
    "SiteActivity" to TargetSpec(SITE_ACTIVITY_METADATA, "DKRetail__SiteAcitivity__c", "site_activities.csv", "domain/activity/inspection/entity/SiteActivity"),
    "MonthlyFemaleEmployeeIntegrationSchedule" to TargetSpec(MONTHLY_FEMALE_EMPLOYEE_INTEGRATION_SCHEDULE_METADATA, "MonthlyFemaleEmployeeIntegrationSchedule__c", "monthly_female_employee_integration_schedules.csv", "domain/activity/schedule/entity/MonthlyFemaleEmployeeIntegrationSchedule"),
    "MonthlySalesHistory" to TargetSpec(MONTHLY_SALES_HISTORY_METADATA, "MonthlySalesHistory__c", "monthly_sales_historys.csv", "domain/sales/entity/MonthlySalesHistory"),
    "DailySalesHistory" to TargetSpec(DAILY_SALES_HISTORY_METADATA, "DailySalesHistory__c", "daily_sales_historys.csv", "domain/sales/entity/DailySalesHistory"),
    "SalesProgressRateMaster" to TargetSpec(SALES_PROGRESS_RATE_MASTER_METADATA, "SalesProgressRateMaster__c", "sales_progress_rate_masters.csv", "domain/sales/entity/SalesProgressRateMaster"),
    "NewProduct" to TargetSpec(NEW_PRODUCT_METADATA, "NewProduct__c", "new_products.csv", "domain/foundation/product/entity/NewProduct"),
    "OrderRequest" to TargetSpec(ORDER_REQUEST_METADATA, "DKRetail__OrderRequest__c", "order_requests.csv", "domain/activity/order/entity/OrderRequest"),
    "OrderRequestProduct" to TargetSpec(ORDER_REQUEST_PRODUCT_METADATA, "DKRetail__OrderRequestProduct__c", "order_request_products.csv", "domain/activity/order/entity/OrderRequestProduct"),
    "ProductBarcode" to TargetSpec(PRODUCT_BARCODE_METADATA, "ProductBarcode__c", "product_barcodes.csv", "domain/foundation/product/entity/ProductBarcode"),
    "ProfessionalPromotionTeamHistory" to TargetSpec(PROFESSIONAL_PROMOTION_TEAM_HISTORY_METADATA, "ProfessionalPromotionTeamHistory__c", "professional_promotion_team_historys.csv", "domain/activity/promotion/entity/ProfessionalPromotionTeamHistory"),
    "ProfessionalPromotionTeamMaster" to TargetSpec(PROFESSIONAL_PROMOTION_TEAM_MASTER_METADATA, "ProfessionalPromotionTeamMaster__c", "professional_promotion_team_masters.csv", "domain/activity/promotion/entity/ProfessionalPromotionTeamMaster"),
    "PromotionEmployee" to TargetSpec(PROMOTION_EMPLOYEE_METADATA, "DKRetail__PromotionEmployee__c", "promotion_employees.csv", "domain/activity/promotion/entity/PromotionEmployee"),
    "PromotionProduct" to TargetSpec(PROMOTION_PRODUCT_METADATA, "DKRetail__PromotionProduct__c", "promotion_products.csv", "domain/activity/promotion/entity/PromotionProduct"),
    "PushMessage" to TargetSpec(PUSH_MESSAGE_METADATA, "PushMessage__c", "push_messages.csv", "platform/push/entity/PushMessage"),
    "PushMessageReceiver" to TargetSpec(PUSH_MESSAGE_RECEIVER_METADATA, "PushMessageReceiver__c", "push_message_receivers.csv", "platform/push/entity/PushMessageReceiver"),
    "TeamMemberSchedule" to TargetSpec(TEAM_MEMBER_SCHEDULE_METADATA, "DKRetail__TeamMemberSchedule__c", "team_member_schedules.csv", "domain/activity/schedule/entity/TeamMemberSchedule"),
    "UploadFile" to TargetSpec(UPLOAD_FILE_METADATA, "UploadFile__c", "upload_files.csv", "platform/common/entity/UploadFile"),
    "Suggestion" to TargetSpec(SUGGESTION_METADATA, "DKRetail__Proposal__c", "suggestions.csv", "domain/activity/suggestion/entity/Suggestion"),
    "UserRole" to TargetSpec(USER_ROLE_METADATA, "UserRole", "user_roles.csv", "platform/auth/entity/UserRole"),
    "Profile" to TargetSpec(PROFILE_METADATA, "Profile", "profiles.csv", "platform/auth/entity/Profile"),
