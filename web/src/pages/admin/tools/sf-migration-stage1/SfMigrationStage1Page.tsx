...
// 공지 본문 이미지 전용 적재 카드는 제거됐다 — 공지사항이 이관 대상에서 제외되어(2026-07-31 운영 결정)
// 부모 공지가 없기 때문. backend 의 NoticeImageUploadFile 타겟 정의는 남아 있어, 공지 이관을 되살리면
// 클레임 이미지 카드와 동일 패턴으로 복원하면 된다 (Stage1Targets.NOTICE KDoc 참조).
