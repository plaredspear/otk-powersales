...
const SECTIONS: DocSection[] = [
  {
    ...
    cards: [
      ...
      },
      {
        ...
        to: '/admin/docs/flows',
        title: '데이터 흐름 (DFD)',
        desc: 'SAP/Orora 유입부터 화면 노출까지 주요 데이터 흐름 다이어그램.',
      ...
      },
      {
        ...
        to: '/admin/docs/api',
        title: 'API 카탈로그',
        desc: 'REST 엔드포인트 분포와 Swagger UI 진입점. 그룹별(admin/mobile/sap) 문서 링크.',
        icon: <ApiOutlined />,
        status: 'ready',
      },
    ],
  ...
  },
  {
    ...
    cards: [
      ...
      {
        key: 'sap-integration',
        to: '/admin/tools/sap-integration',
        title: 'SAP 연동',
        desc: 'SAP 인바운드 수신 / 아웃바운드 송신 호출 이력과 대기 큐 현황.',
