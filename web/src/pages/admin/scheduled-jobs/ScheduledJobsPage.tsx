...
const JOB_DESCRIPTIONS: Record<string, string> = {
  ...
  'account-naver-geocode-batch':
    '위경도 좌표가 비어 있는 거래처를 최대 1000건 조회하여, 각 거래처 주소를 네이버 지도 Geocode API로 변환해 위도·경도를 채워 넣습니다. 거래처상태는 가리지 않아 "출고중지"·"폐업" 거래처도 보강 대상입니다. 거래처 위치를 지도에 표시하기 위한 좌표 보강 배치로, 좌표가 채워지지 못한 거래처는 다음 실행 때 다시 처리 대상이 됩니다.',
  'pptMaster.expire':
