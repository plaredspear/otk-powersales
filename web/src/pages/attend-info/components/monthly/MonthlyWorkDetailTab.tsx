...
export default function MonthlyWorkDetailTab() {
  ...
  // 근무기간 조회 화면(work_history 게이팅) — work-history 전용 endpoint 로 조회해 게이팅 권한과 정합.
  const histQuery = useEmployeeMonthlyWorkHistory(employeeId, employeeId ? yearMonth : undefined, 'workHistory');
  ...
  const handleExport = useCallback(() => {
    ...
    runExport(
      employeeMonthlyWorkHistoryExportPath(employeeId, 'workHistory'),
