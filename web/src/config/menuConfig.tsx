  ...
  children: [
    ...
    },
    {
      ...
      children: [
        ...
        { path: '/settings/organizations', name: '조직마스터', entity: 'organization', operation: 'READ' },
        ...
        {
          path: '/settings/orora-daily-sales',
          name: 'ORORA 일매출',
    ...
    },
    {
      ...
      children: [
        ...
        { path: '/admin/tools/ppt-history-master-id-backfill', name: '전문행사조 이력 마스터 연결 백필', systemPermission: 'MODIFY_ALL_DATA' },
