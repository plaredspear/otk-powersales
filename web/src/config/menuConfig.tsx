...
export const menuRoute: MenuRoute = {
  ...
  children: [
    ...
    },
    {
      ...
      children: [
        { path: '/sales/monthly', name: '월매출 조회', requiredPermission: 'MONTHLY_SALES_DASHBOARD_READ' },
    ...
    },
    {
      ...
      children: [
        ...
        { path: '/admin/tools/sf-migration-stage1', name: 'SF Migration — Stage 1 적재', requiredPermission: 'SF_MIGRATION_RUN' },
        { path: '/admin/tools/sf-migration', name: 'SF Migration — Stage 2 FK', requiredPermission: 'SF_MIGRATION_RUN' },
      ],
    },
  ],
};
