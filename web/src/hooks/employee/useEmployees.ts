...
export function useFemaleEmployees(params: FetchFemaleEmployeesParams) {
  return useQuery({
    queryKey: ['admin', 'female-employees', params.status, params.costCenterCode, params.keyword, params.jobCode, params.workType1, params.workType3, params.professionalPromotionTeam, params.page, params.size],
