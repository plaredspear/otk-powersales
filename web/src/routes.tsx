...
const ElectronicSalesPlaceholderPage = lazy(() => import('@/pages/ElectronicSalesPlaceholderPage'));
      ...
      children: [
        {
          ...
          children: [
            ...
            { path: '/sales/electronic', element: <LazyWrapper><ElectronicSalesPlaceholderPage /></LazyWrapper> },
