-- 스펙 #720: ErpOrder SF Object 정합 (Group A + Reference R-2)
...
ALTER TABLE powersales.erp_order
    ADD CONSTRAINT fk_erp_order_owner
...
CREATE INDEX idx_erp_order_owner_id ON powersales.erp_order (owner_id);
CREATE INDEX idx_erp_order_created_by_id ON powersales.erp_order (created_by_id);
CREATE INDEX idx_erp_order_last_modified_by_id ON powersales.erp_order (last_modified_by_id);
