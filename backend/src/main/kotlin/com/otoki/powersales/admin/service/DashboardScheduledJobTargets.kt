...
object DashboardScheduledJobTargets {
    ...
    val TARGETS: List<Target> = listOf(
        ...
        Target(DisplayMasterLastMonthRevenueBatch.JOB_NAME, "진열 전월매출", "매일 08시"),
        Target(MfeisThisMonthRevenueBatch.JOB_NAME, "일정 평균매출", "매일 08시 05분"),
        ...
        Target(PostponedAppointmentBatch.JOB_NAME, "연기예약 처리", "매일 00시 50분"),
