...
class AdminCacheService(
     ...
     *
     * 권한 가드 캐시 (admin-permission:v1 / admin-data-scope:v1) 도 Redis 정규 등록이라 자동 포함.
     */
    ...
    /**
     * 단일 cache name 전체 evict. Spring `Cache.clear()` (Redis backend 면 `cacheName::*` 전체 키 삭제).
     */
    ...
    /**
     * 등록된 모든 cache (권한 가드 캐시 포함) 일괄 evict.
     *
