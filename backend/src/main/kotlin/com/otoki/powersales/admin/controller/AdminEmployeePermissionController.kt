...
class AdminEmployeePermissionController(
    ...
    fun getEmployeePermissions(
        ...
        val response = adminEmployeePermissionService.getEmployeePermissions(currentEmployee, employeeId)
    ...
    fun updateUserPermissions(
        ...
        val response = adminEmployeePermissionService.updateUserPermissions(currentEmployee, employeeId, request)
        return ResponseEntity.ok(ApiResponse.success(response))
    }
    ...
    fun updateAuthority(
        ...
        val response = adminEmployeePermissionService.updateAuthority(currentEmployee, employeeId, request)
        return ResponseEntity.ok(ApiResponse.success(response))
    }
}
