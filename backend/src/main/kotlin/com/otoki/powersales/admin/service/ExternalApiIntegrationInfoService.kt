...
class ExternalApiIntegrationInfoService(
    ...
    private fun sapInterfaces(): List<ExternalApiIntegrationInfo> {
        ...
        return listOf(
            ...
            sap("attendance", "여사원일정 스케줄", SapConstants.SAP_INTERFACE_ATTENDANCE, "페이지 단위 송신."),
            sap("display-master", "여사원 진열마스터 스케줄", SapConstants.SAP_INTERFACE_DISPLAY_MASTER, "페이지 단위 송신."),
