 ...
 *
 * ┌──────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────┐
 * │ Migrate │ Salesforce Object (API Name)               │ Dev DB (powersales)         │ Entity                  │ 참조키 (sfid FK)                                              │ 비고                          │
 * ├──────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────┤
 * │         │ ── 마스터 데이터 ──────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────── │
 * │  NO     │ Org__c                                      │ organization                │ Organization            │ —                                                             │ @SAPSource 병행               │
 * ├──────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────┤
 * │         │ ── Employee 참조 ─────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────── │
 ...
 * │         │ ── Claim 관련 ────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────── │
 * │  NO     │ DKRetail__Claim__c                          │ claim                       │ Claim                   │ DKRetail__EmployeeId__c → employee.sfid,                      │ V88: sfid 컬럼 추가, employee_id/account_id FK │
