...
import com.otoki.powersales.common.service.MyAccountScope
...
class AccountController(
    ...
    fun getMyAccounts(
        ...
        val response = myAccountService.getMyAccounts(principal.userId, keyword, MyAccountScope.from(scope))
