...
/**
 * SAP 직원 마스터 인바운드 어댑터. (Spec #557 + #579 / 어댑터-도메인 분리: #635 P2-B / audit AOP 통합: #639)
 *
 * 책임:
 ...
 *   1. `REQUEST_ACCEPTED` (success/failure 집계) — [SapInboundAuditAspect] 가 AOP 로 처리 (#639)
 *   2. `MANUAL_ORIGIN_PROTECTED` (#579 보호 직원 코드 목록, 보호 발생 시에만) — 본 어댑터 직접 호출
 *      (도메인 데이터 의존 reason — `protectedManualCodes`)
 *
