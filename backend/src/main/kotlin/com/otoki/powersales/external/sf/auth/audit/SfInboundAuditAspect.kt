...
import com.otoki.powersales.external.sf.inbound.dto.SfInboundChunkedResult
import com.otoki.powersales.external.sf.inbound.dto.SfInboundUpsertResult
...
class SfInboundAuditAspect(
    ...
    @Around("@annotation(com.otoki.powersales.external.sf.auth.audit.SfInboundAccepted)")
