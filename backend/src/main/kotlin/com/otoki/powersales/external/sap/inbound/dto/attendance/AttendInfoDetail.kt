...
import com.otoki.powersales.external.sap.inbound.dto.SapInboundChunkedResult
 ...
 * 외부 응답 JSON 에는 포함되지 않는다 (`@get:JsonIgnore` — 본 필드는 [com.otoki.powersales.external.sap.auth.audit.SapInboundAuditAspect]
