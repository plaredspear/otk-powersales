package com.otoki.powersales.external.sf.auth.controller

import com.otoki.powersales.external.sf.auth.dto.TokenRequest
...
import com.otoki.powersales.external.sf.auth.util.BasicAuthHeader
 ...
 */
@RestController
@RequestMapping("/api/v1/sf/oauth")
class SfTokenController(
    private val sfTokenService: SfTokenService
) {
    ...
    fun issueTokenForm(
        ...
        val response = sfTokenService.issue(tokenRequest, ClientIpResolver.resolve(request))
