package com.otoki.powersales.external.rdp.auth.controller
...
import com.otoki.powersales.external.rdp.auth.util.BasicAuthHeader
 ...
 */
@RestController
@RequestMapping("/api/v1/rdp/oauth")
class RdpTokenController(
    private val rdpTokenService: RdpTokenService
) {
    ...
    fun issueTokenForm(
        ...
        val response = rdpTokenService.issue(tokenRequest, ClientIpResolver.resolve(request))
