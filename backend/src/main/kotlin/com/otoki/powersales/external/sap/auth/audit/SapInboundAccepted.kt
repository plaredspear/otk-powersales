 ...
 * 2. 메서드 호출 후 정상 return — 결과가 [com.otoki.powersales.external.sap.inbound.dto.SapInboundUpsertResult]
 ...
 * - `{chunks}` → 결과가 [com.otoki.powersales.external.sap.inbound.dto.SapInboundChunkedResult] 인 경우 `chunkCount`
 *
 * 사용 예:
 * ```kotlin
