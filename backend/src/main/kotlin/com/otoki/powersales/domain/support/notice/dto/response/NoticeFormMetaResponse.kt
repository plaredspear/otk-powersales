...
data class NoticeFormMetaResponse(
    ...
    /**
     * 목록 화면의 분류 **조회** 선택지 — 선택 가능한 전 분류
     * ([com.otoki.powersales.domain.support.notice.enums.NoticeCategory.SELECTABLE], 교육 제외) 고정.
     *
     * 작성 권한([categories])과 분리한다. 조장/지점장은 지점공지만 작성할 수 있지만, 목록에는 본인 지점공지
     * 외에 회사공지(지점 소속이 없는 전사 공지)도 함께 나오므로 그 분류로 조회도 할 수 있어야 한다.
     */
