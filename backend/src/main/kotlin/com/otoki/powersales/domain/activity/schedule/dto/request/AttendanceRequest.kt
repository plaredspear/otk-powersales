 ...
 * 서비스 레이어에서 검증한다.
 *
 * latitude/longitude 범위(±90 / ±180) 검증은 [com.otoki.powersales.domain.activity.schedule.service.AttendanceService]
 * 에서 [com.otoki.powersales.domain.activity.schedule.exception.InvalidCoordsException] (errorCode `ATT_INVALID_COORDS`)
 * 으로 처리한다 (Spec #585 §4).
 */
