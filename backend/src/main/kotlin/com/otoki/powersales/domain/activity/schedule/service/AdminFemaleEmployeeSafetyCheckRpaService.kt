...
class AdminFemaleEmployeeSafetyCheckRpaService(
    ...
    fun exportReport(scope: DataScope, requestedBranchCode: String?, date: LocalDate?): ExcelResult {
        ...
        val headers = listOf(
            ...
            "점검시간", "출근현황", "HRCode",
            "1) 손목보호대를 착용했습니다.",
            "2) 숨수건(화재피해 예방)을 소지하고 있습니다.",
            "3) 안전화를 착용했습니다.",
            "4) 진열업무시 코팅장갑 및 허리보호대를 착용합니다.",
            "5) 진열대가 높을 경우 안전사다리를 사용합니다.",
            "6) 시식행사 진행시 위생장갑을 사용합니다.",
            "7) 오뚜기 유니폼을 착용하였습니다.",
            "8) 오뚜기 판매여사원 명찰을 착용하였습니다.",
            "9) 코로나 예방 마스크 착용 했습니다.",
            "예방사항 통합관리", "예방사항 총 체크", "근무유형2", "근무유형3", "근무유형4", "여사원일정: 스케줄번호",
        )
