 ...
 *
 * 「월 매출(전산실적)」 web admin 화면의 하단 테이블 — 권한 범위 거래처 N건의 월간 전산매출(POS `live_tot_sales_dh`)
 * 합계를 거래처 1행으로 표현. row 클릭 시 제품별 상세 ([ElectronicSalesDashboardDetailResponse]) 조회.
 */
...
/**
 * 전산실적 명세 테이블 한 행 — 거래처 단위 월간 전산매출 합계.
 *
