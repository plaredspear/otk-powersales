 ...
 *  - 외부 호출: `OrganizationRepository.findFirstByCostCenterCodeCascade()` — Level5/4/3 cascade
...
class EmployeeProfileResolver(
    ...
    fun resolve(employee: Employee): ProfileType {
        ...
        val org = organizationRepository.findFirstByOrgCodeLevel5(costCenterCodeRaw)
            ?: organizationRepository.findFirstByOrgCodeLevel4(costCenterCodeRaw)
            ?: organizationRepository.findFirstByOrgCodeLevel3(costCenterCodeRaw)
