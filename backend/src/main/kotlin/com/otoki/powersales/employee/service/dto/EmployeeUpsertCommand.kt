 ...
 *
 * - UPSERT 키: [employeeCode] (= [com.otoki.powersales.employee.entity.Employee.employeeCode])
 *
 * 외부 채널(SAP 인바운드 등) 의 페이로드를 [com.otoki.powersales.employee.service.EmployeeUpsertService] 가 받기 위한 도메인 용어 모델.
