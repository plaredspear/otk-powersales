 ...
 *
 * - UPSERT 키: [productCode] (= [com.otoki.powersales.product.entity.Product.productCode])
 *
 * 외부 채널(SAP 인바운드 등) 의 페이로드를 [com.otoki.powersales.product.service.ProductUpsertService] 가 받기 위한 도메인 용어 모델.
