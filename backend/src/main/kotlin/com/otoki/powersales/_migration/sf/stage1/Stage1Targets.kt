 ...
 *
 * **FieldMapping nullable 정책** — `nullable = false` (적재 전 NOT NULL pre-filter) 는 SF describe
 * 실측 `nillable = false` 인 필드 (= SF 표준 시스템 필드 Id/CreatedDate/LastModifiedDate 및
 * SF 가 실제 필수로 강제하는 커스텀 필드) 에만 부여한다. SF 가 NULL 을 허용하는 필드 (describe
 * `nillable = true`, field-meta `required = false`) 에 `nullable = false` 를 잘못 부여하면, SF 가
 * 공란으로 둔 운영 row 가 "필수 필드 누락" 으로 전량 탈락한다 (OrderRequestProduct.amount 운영
 * 전건 공란 → 495만 row 적재 0건 사건). 대응 DB 컬럼이 NOT NULL 이면 함께 DROP NOT NULL 하여
 * SF NULL 을 NULL 그대로 보존 (V202606231430 / V202606231435).
 */
object Stage1Targets {
    ...
    private val STAFF_REVIEW = EntityMetadata(
        ...
        fields = listOf(
            ...
            FieldMapping("CostCenterCode__c", "cost_center_code"),
            FieldMapping("EmployeeTotalScore__c", "employee_total_score"),
            FieldMapping("Attendance__c", "attendance_score"),
            FieldMapping("InstructionsDefault__c", "instruction_disobedience_score"),
            FieldMapping("Priority_EventItemManage__c", "priority_item_event_score"),
            FieldMapping("DisplayManageEventGoals__c", "display_event_goal_score"),
            FieldMapping("BusinessPartnerTies__c", "account_partnership_score"),
            FieldMapping("ClothesSatellite__c", "clothes_hygiene_score"),
            FieldMapping("ProductManageCallment__c", "product_manage_callment_score"),
            FieldMapping("EducationalEvaluation__c", "education_evaluation_score"),
            ...
            FieldMapping("FirstDayofMonth__c", "first_day_of_month"),
            FieldMapping("EmployeeType__c", "employee_type"),
            FieldMapping("EntryDate__c", "entry_date"),
    ...
    private val PRODUCT = EntityMetadata(
        ...
        fields = listOf(
            FieldMapping("Id", "sfid", nullable = false),
            FieldMapping("Name", "name"),
            FieldMapping("DKRetail__ProductCode__c", "product_code"),
    ...
    private val ACCOUNT_CATEGORY_MASTER = EntityMetadata(
        ...
        fields = listOf(
            FieldMapping("Id", "sfid", nullable = false),
            FieldMapping("AccountCode__c", "account_code"),
            FieldMapping("Name", "name", nullable = false),
    ...
    private val AGREEMENT_HISTORY = EntityMetadata(
        ...
        fields = listOf(
            ...
            FieldMapping("AgreementDate__c", "agreement_date"),
    ...
    private val ALTERNATIVE_HOLIDAY = EntityMetadata(
        ...
        fields = listOf(
            ...
            FieldMapping("DKRetail__ActualWorkDate__c", "actual_work_date"),
            FieldMapping("DKRetail__TargetAltHolidayDate__c", "target_alt_holiday_date"),
    ...
    private val APPOINTMENT = EntityMetadata(
        ...
        fields = listOf(
            ...
            FieldMapping("AppointmentDate__c", "appoint_date"),
    ...
    private val CLAIM = EntityMetadata(
        ...
        fields = listOf(
            ...
            FieldMapping("DKRetail__ClaimDate__c", "date"),
            FieldMapping("DKRetail__ClaimType1__c", "claim_type1"),
            FieldMapping("DKRetail__ClaimType2__c", "claim_type2"),
            FieldMapping("DKRetail__Description__c", "defect_description"),
            FieldMapping("DKRetail__Quantity__c", "defect_quantity"),
    ...
    private val ERP_ORDER_PRODUCT = EntityMetadata(
        ...
        fields = listOf(
            ...
            FieldMapping("SAPOrderNumber__c", "sap_order_number"),
            FieldMapping("LineNumber__c", "line_number"),
            FieldMapping("ExternalKey__c", "external_key"),
    ...
    private val HOLIDAY_MASTER = EntityMetadata(
        ...
        fields = listOf(
            FieldMapping("Id", "sfid", nullable = false),
            FieldMapping("HolidayDate__c", "holiday_date"),
            FieldMapping("Name", "name", nullable = false),
            FieldMapping("Type__c", "type"),
            FieldMapping("OwnerId", "owner_sfid"),
            FieldMapping("CreatedById", "created_by_sfid"),
            FieldMapping("CreatedDate", "created_at", nullable = false),
            FieldMapping("LastModifiedDate", "updated_at", nullable = false),
    ...
    private val ORDER_REQUEST = EntityMetadata(
        ...
        fields = listOf(
            ...
            FieldMapping("DKRetail__RequestDate__c", "delivery_date"),
            FieldMapping("TotalOrderAmount__c", "total_amount"),
            FieldMapping("DKRetail__RequestStatus__c", "order_request_status"),
            FieldMapping("OwnerId", "owner_sfid"),
            FieldMapping("CreatedById", "created_by_sfid"),
            FieldMapping("CreatedDate", "created_at", nullable = false),
            FieldMapping("LastModifiedDate", "updated_at", nullable = false),
    ...
    private val ORDER_REQUEST_PRODUCT = EntityMetadata(
        ...
        fields = listOf(
            ...
            FieldMapping("ProductCode__c", "product_code"),
            FieldMapping("TotalQuantity_Box__c", "quantity_boxes"),
            FieldMapping("TotalQuantity_Each__c", "quantity_pieces"),
            FieldMapping("DKRetail__OrderingUnit__c", "unit"),
            FieldMapping("DKRetail__TotalAmount__c", "amount"),
    ...
    private val PROFESSIONAL_PROMOTION_TEAM_HISTORY = EntityMetadata(
        ...
        fields = listOf(
            ...
            FieldMapping("newValue__c", "new_value"),
            FieldMapping("updateTime__c", "changed_at"),
            FieldMapping("OwnerId", "owner_sfid"),
            FieldMapping("CreatedById", "created_by_sfid"),
            FieldMapping("CreatedDate", "created_at", nullable = false),
            FieldMapping("LastModifiedDate", "updated_at", nullable = false),
    ...
    private val PROFESSIONAL_PROMOTION_TEAM_MASTER = EntityMetadata(
        ...
        fields = listOf(
            ...
            FieldMapping("ProfessionalPromotionTeam__c", "team_type"),
    ...
    private val SUGGESTION = EntityMetadata(
        ...
        fields = listOf(
            ...
            FieldMapping("DKRetail__Title__c", "title"),
            FieldMapping("DKRetail__Description__c", "content"),
            FieldMapping("Category__c", "category"),
    ...
    private val PERMISSION_SET_ASSIGNMENT = EntityMetadata(
        ...
        fields = listOf(
            ...
            FieldMapping("PermissionSetId", "permission_set_sfid"),
