...
import com.otoki.powersales.sap.service.SapOrganizeMasterService
...
@RestController
@RequestMapping("/api/v1/sap/organize-master")
class SapOrganizeMasterController(
    ...
    @PostMapping
    fun syncOrganizeMaster(
        @RequestBody request: SapOrganizeMasterRequest,
        ...
        return try {
            val result = sapOrganizeMasterService.sync(request.reqItemList)
