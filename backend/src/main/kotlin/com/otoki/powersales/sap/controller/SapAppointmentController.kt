...
import com.otoki.powersales.sap.dto.SapAppointmentRequest
import com.otoki.powersales.sap.dto.SapSyncResponse
import com.otoki.powersales.sap.dto.SapSyncResult
import com.otoki.powersales.sap.service.SapAppointmentService
...
@RestController
@RequestMapping("/api/v1/sap/appointment")
class SapAppointmentController(
    ...
    @PostMapping
    fun syncAppointment(
        @RequestBody request: SapAppointmentRequest,
        ...
        return try {
            val result = sapAppointmentService.sync(request.reqItemList)
