...
import com.otoki.powersales.sap.service.SapAttendInfoService
...
@RestController
@RequestMapping("/api/v1/sap/attend-info")
class SapAttendInfoController(
    ...
    @PostMapping
    fun syncAttendInfo(
        @RequestBody request: SapAttendInfoRequest,
        ...
        return try {
            val result = sapAttendInfoService.sync(request.reqItemList)
