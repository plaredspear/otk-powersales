...
class EntitySfNameRegistry(
    ...
    private val resourceCatalog: MutableSet<String> = java.util.concurrent.ConcurrentHashMap.newKeySet()
    ...
    private fun indexPermissionResources() {
        ...
        for ((beanName, bean) in beans) {
            ...
            val targetClass = org.springframework.aop.support.AopUtils.getTargetClass(bean)
