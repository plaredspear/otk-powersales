...
import com.otoki.powersales.auth.sharing.entity.QSharingRule.Companion.sharingRule
...
class SharingPolicyQueryRepository(
     ...
     * [com.otoki.powersales.auth.sharing.service.SharingRecalcService.recalcAll] 로 일괄 evict.
