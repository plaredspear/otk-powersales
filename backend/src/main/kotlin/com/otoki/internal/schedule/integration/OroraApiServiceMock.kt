 ...
 * 항상 성공 응답을 반환하고, TeamMemberSchedule.commuteLogId를 'OK'로 직접 업데이트한다.
...
class OroraApiServiceMock(
    ...
    override fun sendWorkReport(scheduleSfid: String, reason: String?): OroraWorkReportResult {
        // Mock: TeamMemberSchedule.commuteLogId를 'OK'로 직접 업데이트 (Orora→SF 동기화 시뮬레이션)
        teamMemberScheduleRepository.updateCommuteLogId(scheduleSfid, "OK")
