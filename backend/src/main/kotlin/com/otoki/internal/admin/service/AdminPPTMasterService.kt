...
import com.otoki.internal.admin.dto.request.PPTMasterBulkItem
...
import com.otoki.internal.promotion.repository.PPTHistoryRepository
import com.otoki.internal.promotion.repository.PPTMasterRepository
...
class AdminPPTMasterService(
    ...
    fun generateExcelTemplate(): ByteArray {
        val employees = employeeRepository.findByAppAuthorityAndStatus("여사원", "재직")
