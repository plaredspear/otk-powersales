...
import com.otoki.powersales.sap.dto.SapAccountCategoryMasterRequest.ReqItem
...
@DisplayName("SapAccountCategoryMasterService 테스트")
class SapAccountCategoryMasterServiceTest {
    ...
    inner class NewAccountCategoryTests {
        ...
        fun sync_newAccountCategory_creates() {
            ...
            val result = sapAccountCategoryMasterService.sync(items)
