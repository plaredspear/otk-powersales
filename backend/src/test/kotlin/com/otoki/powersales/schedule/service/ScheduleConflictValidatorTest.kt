...
class ScheduleConflictValidatorTest {
    ...
    inner class NoConflict {
        ...
        fun noExisting() {
            ...
            assertThatCode {
                validator.validateConflicts(targetEmployeeId, workingDate, "근무", accountId, "고정")
        ...
        fun nonWorkType_passesThrough() {
            stubExisting(listOf(workSchedule(category3 = "고정")))
            assertThatCode {
                validator.validateConflicts(targetEmployeeId, workingDate, "연차", null, null)
            }.doesNotThrowAnyException()
        }
    }
    ...
    inner class Rule1 {
        ...
        fun annualLeave() {
            stubExisting(listOf(leaveSchedule("연차")))
            assertThatThrownBy {
                validator.validateConflicts(targetEmployeeId, workingDate, "근무", accountId, "고정")
        ...
        fun altHoliday() {
            stubExisting(listOf(leaveSchedule("대휴")))
            assertThatThrownBy {
                validator.validateConflicts(targetEmployeeId, workingDate, "근무", accountId, "고정")
            }.isInstanceOf(LeaderScheduleDuplicateLeaveException::class.java)
        }
    ...
    inner class Rule2 {
        ...
        fun sameAccount() {
            stubExisting(listOf(workSchedule(category3 = "순회", accountIdValue = accountId)))
            assertThatThrownBy {
                validator.validateConflicts(targetEmployeeId, workingDate, "근무", accountId, "순회")
        ...
        fun differentAccount_passesRule2() {
            stubExisting(listOf(workSchedule(category3 = "순회", accountIdValue = 99999)))
    ...
    inner class Rule3And4 {
        ...
        fun fixedLimit() {
            stubExisting(listOf(workSchedule(category3 = "고정", accountIdValue = 11111)))
            assertThatThrownBy {
                validator.validateConflicts(targetEmployeeId, workingDate, "근무", accountId, "고정")
        ...
        fun biweeklyLimit() {
            stubExisting(listOf(
                workSchedule(category3 = "격고", accountIdValue = 11111),
                workSchedule(category3 = "격고", accountIdValue = 22222)
            ))
            assertThatThrownBy {
                validator.validateConflicts(targetEmployeeId, workingDate, "근무", accountId, "격고")
            }.isInstanceOf(LeaderScheduleCategory3LimitExceededException::class.java)
        }
    }
    ...
    inner class Rule5To7 {
        ...
        fun fixedVsBiweekly() {
            stubExisting(listOf(workSchedule(category3 = "격고", accountIdValue = 11111)))
            assertThatThrownBy {
                validator.validateConflicts(targetEmployeeId, workingDate, "근무", accountId, "고정")
        ...
        fun fixedVsRotating() {
            stubExisting(listOf(workSchedule(category3 = "순회", accountIdValue = 11111)))
            assertThatThrownBy {
                validator.validateConflicts(targetEmployeeId, workingDate, "근무", accountId, "고정")
            }.isInstanceOf(LeaderScheduleCategory3ConflictException::class.java)
        }
    ...
    private fun workSchedule(category3: String, accountIdValue: Int? = null): TeamMemberSchedule {
    ...
    private fun leaveSchedule(workingType: String): TeamMemberSchedule {
        return TeamMemberSchedule(
            employee = Employee(id = targetEmployeeId, employeeCode = "20300001", name = "팀원"),
            workingDate = workingDate,
