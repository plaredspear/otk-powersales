...
import com.otoki.powersales.sales.dto.request.DailySalesCreateRequest
import com.otoki.powersales.sales.entity.DailySales
import com.otoki.powersales.event.entity.Event
import com.otoki.powersales.sales.exception.*
...
class DailySalesServiceTest {
    ...
    private fun createTestUser(): com.otoki.powersales.common.entity.User {
        return com.otoki.powersales.common.entity.User(
            id = testUserId,
    ...
    fun registerDailySales_Failure_NotAssignee() {
        ...
        val otherUser = createTestUser().apply {
            val userWithDifferentId = com.otoki.powersales.common.entity.User(
                id = testUserId,
                employeeCode = "99999",
                password = "encoded",
                name = "다른사람",
        ...
        whenever(employeeRepository.findById(testUserId)).thenReturn(Optional.of(
            com.otoki.powersales.common.entity.User(
                id = testUserId,
                employeeCode = "99999",
                password = "encoded",
                name = "다른사람",
