...
class AdminWorkingDayMasterServiceTest {
    ...
    fun rejectsOutOfRangeMonth() {
        org.assertj.core.api.Assertions.assertThatThrownBy { service.getWorkingDayMasters(2026, 13) }
            .isInstanceOf(IllegalArgumentException::class.java)
        org.assertj.core.api.Assertions.assertThatThrownBy { service.getWorkingDayMasters(2026, 0) }
            .isInstanceOf(IllegalArgumentException::class.java)
    }
