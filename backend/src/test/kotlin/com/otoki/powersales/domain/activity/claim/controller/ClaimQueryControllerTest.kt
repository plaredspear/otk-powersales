...
import com.otoki.powersales.domain.activity.claim.dto.response.ClaimPhotoItem
    ...
    inner class GetClaimsTests {
        ...
        fun getClaims_success() {
            ...
            mockMvc.perform(get("/api/v1/mobile/claims"))
                ...
                .andExpect(jsonPath("$.data[0].actionStatusLabel").value("미확인"))
        }
        ...
        @MethodSource("com.otoki.powersales.domain.activity.claim.controller.ClaimQueryControllerTest#getClaimsExceptions")
