...
class ClaimSFAnnotationTest {
    ...
    inner class ReferenceR2 {
        ...
        fun referenceFks() {
            mapOf(
                "ownerUser" to ("owner_user_id" to User::class.java),
                "ownerGroup" to ("owner_group_id" to Group::class.java),
                "createdBy" to ("created_by_id" to User::class.java),
                "lastModifiedBy" to ("last_modified_by_id" to User::class.java),
