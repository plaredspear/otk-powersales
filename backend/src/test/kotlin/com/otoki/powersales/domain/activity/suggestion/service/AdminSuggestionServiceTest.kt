...
class AdminSuggestionServiceTest {
    ...
    inner class SearchTests {
        ...
        fun invalidDateRange() {
            assertThatThrownBy {
                service.search(allowAllScope, LocalDate.of(2026, 5, 27), LocalDate.of(2026, 5, 26),
                    AdminSuggestionFilterParams(), 0, 20)
        ...
        fun appliesSharingPolicy() {
            ...
            val predicateSlot = slot<Predicate>()
    ...
    inner class CreateTests {
        ...
        fun createsOnBehalfOfEmployee() {
            ...
            every { photoUploader.store(any(), any()) } returns SuggestionPhotoUploader.StoredPhoto(
                uniqueKey = "uploads/suggestion/new.jpg",
                sfUniqueKey = "1750000000000EMP100",
                fileName = "p_resize.jpg",
                fileSize = "2.0Byte",
            )
