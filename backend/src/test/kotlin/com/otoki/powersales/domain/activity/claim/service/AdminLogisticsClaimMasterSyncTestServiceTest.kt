...
@DisplayName("AdminLogisticsClaimMasterSyncTestService (SF IF_SendLogisticsClaimToPWS 조회 테스트 도구) 테스트")
class AdminLogisticsClaimMasterSyncTestServiceTest {
    ...
    fun setUp() {
        ...
        service = AdminLogisticsClaimMasterSyncTestService(sfOutboundClient, ObjectMapper())
    }
    ...
    fun test_callsSfWithModDt() {
        val rawList = """[{"DKRetailProductId":"P-1","ActionStatus":"접수"}]"""
