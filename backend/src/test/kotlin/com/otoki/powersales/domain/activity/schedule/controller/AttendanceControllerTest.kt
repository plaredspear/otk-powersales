...
class AttendanceControllerTest : MobileControllerTestSupport() {
    ...
    inner class RegisterTests {
        ...
        /**
         * 분기별 비즈니스 검증은 [com.otoki.powersales.domain.activity.schedule.service.AttendanceServiceTest] 가 담당.
         * controller 책임은 예외 → HTTP status + errorCode 매핑이므로 본 파라미터 테이블로 1테스트로 집약.
         */
        @ParameterizedTest(name = "{0} → {1} {2}")
        @MethodSource("com.otoki.powersales.domain.activity.schedule.controller.AttendanceControllerTest#registerExceptionCases")
