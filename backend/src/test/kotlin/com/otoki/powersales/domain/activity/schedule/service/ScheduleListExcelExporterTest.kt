...
class ScheduleListExcelExporterTest {
    ...
    fun export_headersAndRows() {
        ...
        assertThat(header.getCell(0).stringCellValue).isEqualTo("유효")
        assertThat(header.getCell(1).stringCellValue).isEqualTo("지점명")
        assertThat(header.getCell(2).stringCellValue).isEqualTo("사번")
        assertThat(header.getCell(3).stringCellValue).isEqualTo("성명")
        ...
        assertThat(row.getCell(2).stringCellValue).isEqualTo("20030001")
