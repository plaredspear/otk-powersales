...
class AuthControllerTest : MobileControllerTestSupport() {
    ...
    @MethodSource("com.otoki.powersales.platform.auth.controller.AuthControllerTest#refreshExceptions")
    ...
    @ParameterizedTest(name = "{0}")
    @MethodSource("com.otoki.powersales.platform.auth.controller.AuthControllerTest#changePasswordExceptions")
