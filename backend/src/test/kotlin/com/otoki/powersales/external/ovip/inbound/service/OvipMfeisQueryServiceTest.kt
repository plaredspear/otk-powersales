...
@DisplayName("OvipMfeisQueryService 테스트")
class OvipMfeisQueryServiceTest {
    ...
    ): OvipMfeisQueryService {
        val props = OvipInboundProperties(
            mfeis = OvipInboundProperties.Mfeis(
                defaultPageSize = defaultPageSize,
                maxPageSize = maxPageSize,
            )
        )
        return OvipMfeisQueryService(repository, props, auditService)
    }
    ...
    inner class RequiredParams {
        ...
        @Test
        @DisplayName("year 누락 -> OvipInvalidParameterException")
        fun missingYear() {
            assertThatThrownBy { service().search(req(year = null), "c", "127.0.0.1") }
                .isInstanceOf(OvipInvalidParameterException::class.java)
        }

        @Test
        @DisplayName("year 공백 -> OvipInvalidParameterException")
        fun blankYear() {
        ...
        @Test
        @DisplayName("month 누락 -> OvipInvalidParameterException")
        fun missingMonth() {
