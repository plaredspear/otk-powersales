...
@DisplayName("RdpEmployeeQueryService 테스트")
class RdpEmployeeQueryServiceTest {
    ...
    private fun service(
        ...
        maxPageSize: Int = 500,
    ): RdpEmployeeQueryService {
        val props = RdpInboundProperties(
            employee = RdpInboundProperties.Pagination(
                defaultPageSize = defaultPageSize,
                maxPageSize = maxPageSize,
            )
        )
        return RdpEmployeeQueryService(repository, props, auditService)
    }
    ...
    inner class Audit {
        ...
        fun auditAccepted() {
            ...
            assertThat(auditSlot.captured.endpoint).isEqualTo(RdpEmployeeQueryService.ENDPOINT)
        }
    }
}
