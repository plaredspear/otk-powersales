...
/**
 * RDP 전량 스냅샷 keyset 조회의 DB 레벨 정합 + **N+1 회귀 방어**.
 *
 * 서비스 단위 테스트([RdpAccountQueryServiceTest] / [RdpEmployeeQueryServiceTest])는 repository 를
...
class RdpSnapshotKeysetRepositoryTest {
