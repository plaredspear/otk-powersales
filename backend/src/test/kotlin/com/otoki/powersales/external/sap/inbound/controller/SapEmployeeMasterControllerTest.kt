...
import com.otoki.powersales.external.sap.inbound.controller.SapEmployeeMasterController
...
class SapEmployeeMasterControllerTest {
    ...
    inner class UpsertEmployee {
        ...
        @MethodSource("com.otoki.powersales.external.sap.inbound.controller.SapEmployeeMasterControllerTest#invalidPayloadCases")
