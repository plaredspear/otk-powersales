...
@DisplayName("RdpAccountQueryService 테스트")
class RdpAccountQueryServiceTest {
    ...
    private fun service(
        ...
        maxPageSize: Int = 500,
    ): RdpAccountQueryService {
        val props = RdpInboundProperties(
            account = RdpInboundProperties.Pagination(
                defaultPageSize = defaultPageSize,
                maxPageSize = maxPageSize,
            )
        )
        return RdpAccountQueryService(repository, props, auditService)
    }
    ...
    inner class Audit {
        ...
        fun auditAccepted() {
            ...
            assertThat(auditSlot.captured.endpoint).isEqualTo(RdpAccountQueryService.ENDPOINT)
        }
    }
}
