...
class AttendanceServiceTest {
    ...
    inner class GetStoreListTests {
        ...
        fun getStoreList_threeSchedules_returnsThreeStoresWithGps() {
            ...
            val schedules = listOf(
                createSchedule(sfid = "SCH001", employeeId = "USR001", accountId = "ACC001", workingCategory1 = "진열"),
                createSchedule(sfid = "SCH002", employeeId = "USR001", accountId = "ACC002", workingCategory1 = "납품"),
                createSchedule(sfid = "SCH003", employeeId = "USR001", accountId = "ACC003", workingCategory1 = "진열")
            )
            ...
            whenever(scheduleRepository.findByEmployeeIdAndWorkingDate("USR001", today)).thenReturn(schedules)
        ...
        fun getStoreList_withKeyword_returnsFilteredResults() {
            ...
            val schedules = listOf(
                createSchedule(sfid = "SCH001", employeeId = "USR001", accountId = "ACC001"),
                createSchedule(sfid = "SCH002", employeeId = "USR001", accountId = "ACC002"),
                createSchedule(sfid = "SCH003", employeeId = "USR001", accountId = "ACC003")
            )
        ...
        fun getStoreList_noSchedules_returnsEmptyList() {
            ...
            whenever(userRepository.findById(userId)).thenReturn(Optional.of(user))
            whenever(scheduleRepository.findByEmployeeIdAndWorkingDate("USR001", today)).thenReturn(emptyList())
        ...
        fun getStoreList_withPartialRegistrations_returnsCorrectCount() {
            ...
            val schedules = listOf(
                createSchedule(sfid = "SCH001", employeeId = "USR001", accountId = "ACC001", commuteLogId = "OK"),
                createSchedule(sfid = "SCH002", employeeId = "USR001", accountId = "ACC002", commuteLogId = null)
            )
    ...
    inner class RegisterCommuteTests {
        ...
        fun registerCommute_withinDistance_success() {
            // Given
            val userId = 1L
            val scheduleSfid = "SCH001"
            val user = createUser(id = userId, sfid = "USR001")
            val today = LocalDate.now()

            val schedule = createSchedule(
                sfid = scheduleSfid, employeeId = "USR001", accountId = "ACC001",
            ...
            whenever(userRepository.findById(userId)).thenReturn(Optional.of(user))
            whenever(scheduleRepository.findBySfid(scheduleSfid)).thenReturn(schedule)
            ...
            whenever(scheduleRepository.findByEmployeeIdAndWorkingDate("USR001", today))
                .thenReturn(listOf(schedule))

            // When
            val result = attendanceService.registerCommute(userId, scheduleSfid, nearUserLat, nearUserLon, null)

            // Then
            assertThat(result.scheduleSfid).isEqualTo(scheduleSfid)
        ...
        fun registerCommute_exceedsDistance_throwsException() {
            ...
            // When & Then
            assertThatThrownBy {
                attendanceService.registerCommute(userId, scheduleSfid, farUserLat, farUserLon, null)
        ...
        fun registerCommute_exemptCode1110_success() {
            ...
            // When
            val result = attendanceService.registerCommute(userId, scheduleSfid, farLat, farLon, null)
        ...
        fun registerCommute_exemptCode1900_success() {
            ...
            // When
            val result = attendanceService.registerCommute(userId, scheduleSfid, veryFarLat, veryFarLon, null)
        ...
        fun registerCommute_alreadyRegistered_throwsException() {
            ...
            // When & Then
            assertThatThrownBy {
                attendanceService.registerCommute(userId, scheduleSfid, nearUserLat, nearUserLon, null)
            }.isInstanceOf(AlreadyRegisteredException::class.java)
        }

        @Test
        @DisplayName("스케줄 미존재 -> ScheduleNotFoundException")
        fun registerCommute_scheduleNotFound_throwsException() {
            // Given
            val userId = 1L
            val scheduleSfid = "NONEXISTENT"
            val user = createUser(id = userId, sfid = "USR001")

            whenever(userRepository.findById(userId)).thenReturn(Optional.of(user))
            whenever(scheduleRepository.findBySfid(scheduleSfid)).thenReturn(null)
        ...
        fun registerCommute_withWorkType_returnsProvidedWorkType() {
            ...
            // When
            val result = attendanceService.registerCommute(userId, scheduleSfid, nearUserLat, nearUserLon, "냉장")
        ...
        fun registerCommute_success_returnsCorrectCounts() {
            ...
            val targetSchedule = createSchedule(
                sfid = scheduleSfid, employeeId = "USR001", accountId = "ACC001",
                workingType = "상온", commuteLogId = null
            )
            val account = createAccount(
            ...
            val allSchedules = listOf(
                targetSchedule,
                createSchedule(sfid = "SCH002", employeeId = "USR001", accountId = "ACC002", commuteLogId = "OK"),
                createSchedule(sfid = "SCH003", employeeId = "USR001", accountId = "ACC003", commuteLogId = null)
            )

            whenever(userRepository.findById(userId)).thenReturn(Optional.of(user))
            whenever(scheduleRepository.findBySfid(scheduleSfid)).thenReturn(targetSchedule)
            whenever(accountRepository.findBySfid("ACC001")).thenReturn(account)
            doReturn(OroraWorkReportResult("200", "SUCCESS"))
                .whenever(ororaApiService).sendWorkReport(any(), anyOrNull())
            whenever(scheduleRepository.findByEmployeeIdAndWorkingDate("USR001", today))
            ...
            // Then
            assertThat(result.totalCount).isEqualTo(3)
            // SCH002 has commuteLogId="OK", SCH001 matches scheduleSfid => 2 registered
    ...
    inner class GetCommuteStatusTests {
        ...
        fun getCommuteStatus_threeSchedulesTwoRegistered_returnsCorrectStatus() {
            ...
            val schedules = listOf(
                createSchedule(sfid = "SCH001", employeeId = "USR001", accountId = "ACC001", commuteLogId = "OK", workingCategory1 = "진열"),
                createSchedule(sfid = "SCH002", employeeId = "USR001", accountId = "ACC002", commuteLogId = "OK", workingCategory1 = "납품"),
                createSchedule(sfid = "SCH003", employeeId = "USR001", accountId = "ACC003", commuteLogId = null, workingCategory1 = "진열")
            )
        ...
        fun getCommuteStatus_noneRegistered_returnsAllPending() {
            ...
            val schedules = listOf(
                createSchedule(sfid = "SCH001", employeeId = "USR001", accountId = "ACC001", commuteLogId = null),
                createSchedule(sfid = "SCH002", employeeId = "USR001", accountId = "ACC002", commuteLogId = null)
            )
