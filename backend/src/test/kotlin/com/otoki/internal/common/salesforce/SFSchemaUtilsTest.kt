...
class SFSchemaUtilsTest {
    ...
    inner class GetSFMappingTests {
        ...
        fun getSFMapping_teamMemberSchedule() {
            ...
            assertThat(mapping["teamleadersfid__c"]).isEqualTo("team_leader_id")
            ...
            assertThat(mapping["DKRetail__PromotionEmpId__c"]).isEqualTo("promotion_employee_id")
        ...
        fun getSFMapping_displayWorkSchedule() {
            ...
            assertThat(mapping["FullName__c"]).isEqualTo("employee_number")
