...
class AdminAccountServiceTest {
    ...
    inner class GetAccountsTests {
        ...
        fun allBranches_noFilter() {
            ...
            // When
            val result = adminAccountService.getAccounts(1L, null, null, null, null, 0, 20)
        ...
        fun allBranches_withBranchCode() {
            ...
            val result = adminAccountService.getAccounts(1L, null, null, "A001", null, 0, 20)
        ...
        fun branchOnly_forbiddenBranch() {
            ...
            val result = adminAccountService.getAccounts(1L, null, null, "B002", null, 0, 20)
        ...
        fun keywordFilter() {
            ...
            val result = adminAccountService.getAccounts(1L, "GS25", null, null, null, 0, 20)
        ...
        fun abcTypeFilter() {
            ...
            val result = adminAccountService.getAccounts(1L, null, "편의점", null, null, 0, 20)
        ...
        fun statusFilter() {
            ...
            val result = adminAccountService.getAccounts(1L, null, null, null, "활성", 0, 20)
