...
class AdminTeamScheduleControllerTest {
    ...
    inner class GetMembers {
        ...
        fun getMembers_success() {
            val members = listOf(
                TeamMemberDto(employeeId = "SF001", empCode = "20030001", name = "홍길동"),
                TeamMemberDto(employeeId = "SF002", empCode = "20030002", name = "김영희")
            )
            ...
            mockMvc.perform(get("/api/v1/admin/team-schedule/members"))
                ...
                .andExpect(jsonPath("$.data[0].employee_id").value("SF001"))
                .andExpect(jsonPath("$.data[0].emp_code").value("20030001"))
                .andExpect(jsonPath("$.data[0].name").value("홍길동"))
                .andExpect(jsonPath("$.data[1].employee_id").value("SF002"))
