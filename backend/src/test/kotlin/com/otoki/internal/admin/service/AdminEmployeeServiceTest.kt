...
class AdminEmployeeServiceTest {
    ...
    inner class GetEmployeesTests {
        ...
        fun allBranches_noFilter() {
            ...
            // When
            val result = adminEmployeeService.getEmployees(1L, null, null, null, null, 0, 20)
        ...
        fun allBranches_withCostCenterCode() {
            ...
            val result = adminEmployeeService.getEmployees(1L, null, "A001", null, null, 0, 20)
        ...
        fun branchOnly_forbiddenBranch() {
            ...
            val result = adminEmployeeService.getEmployees(1L, null, "B002", null, null, 0, 20)
        ...
        fun statusFilter() {
            ...
            val result = adminEmployeeService.getEmployees(1L, "재직", null, null, null, 0, 20)
        ...
        fun keywordFilter() {
            ...
            val result = adminEmployeeService.getEmployees(1L, null, null, "홍", null, 0, 20)
