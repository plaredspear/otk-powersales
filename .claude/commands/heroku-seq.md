...
`docs/plan/old_source/summaries/_index.md` 파일을 읽어서:
...
```
docs/plan/old_source/summaries/docs/<모듈명>.md
```
...
python3 -c "
import re, pathlib
text = pathlib.Path('docs/plan/old_source/summaries/docs/<모듈명>.md').read_text()
...
mkdir -p docs/plan/old_source/summaries/docs/attachments
npx @mermaid-js/mermaid-cli -i /tmp/<모듈명>-seq.mmd -o docs/plan/old_source/summaries/docs/attachments/<모듈명>-sequence.svg -b white
```
...
```
✅ <기능명> 기능 분석이 완료되었습니다.
📄 분석 문서: docs/plan/old_source/summaries/docs/<모듈명>.md
🖼️ SVG:      docs/plan/old_source/summaries/docs/attachments/<모듈명>-sequence.svg
📋 BDD:      docs/plan/old_source/summaries/docs/<모듈명>-bdd.md
```
