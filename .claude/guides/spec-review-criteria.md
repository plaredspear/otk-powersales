...
Sonnet 4.6 (200K 컨텍스트)가 Part Issue를 받고 구현을 완료하기까지의 토큰 배분:

| 단계 | 구성 요소 | 토큰 (추정) | 통제 주체 |
|------|----------|:-----------:|----------|
| 가이드 로드 | System + CLAUDE.md + impl-mode.md + conventions | ~15K | 프로젝트 설정 (고정) |
| **스펙 읽기** | **Part Issue 본문** | **~3-6K (목표)** | **스펙 작성자** |
...
## 카테고리 9: Part Issue 분할 적합성

대상: 전체 (B/M/W)

이 카테고리는 Part 단위 GitHub Issue 분할 시 적합성을 평가합니다.
...
| P4 | Part Issue 본문 크기 | 각 Part ~400줄 이하 예상 | 일부 Part 400~600줄 예상 | Part 600줄 초과 예상 |
...
| 카테고리 | B (Backend) | M (Mobile) | W (Web) |
|---------|:-----------:|:----------:|:-------:|
| 1. 구조적 완성도 | O | O | O |
| 2. API 계약 정밀도 | O | - | - |
| 3. 데이터 모델 명확성 | O | O | O |
| 4. 비즈니스 로직 구체성 | O | O | - |
| 5. 테스트 시나리오 구체성 | O | O | O |
| 6. UI/UX 명확성 | - | O | O |
| 7. 컨텍스트 윈도우 적합성 | O | O | O |
| 8. 의존성 명확성 | O | O | O |
| 9. Part Issue 분할 적합성 | O | O | O |
