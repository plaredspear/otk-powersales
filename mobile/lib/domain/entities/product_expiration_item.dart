...
class ProductExpirationItem {
  ...
  ProductExpirationItem copyWith({
    int? seq,
    String? productCode,
    String? productName,
    String? accountCode,
  ...
  factory ProductExpirationItem.fromJson(Map<String, dynamic> json) {
    return ProductExpirationItem(
      seq: json['seq'] as int,
  ...
  bool operator ==(Object other) {
    ...
    if (other is! ProductExpirationItem) return false;
  ...
  @override
  String toString() {
    return 'ProductExpirationItem(seq: $seq, productCode: $productCode, '
...
class ProductExpirationFilter {
  ...
  bool operator ==(Object other) {
    if (identical(this, other)) return true;
    if (other is! ProductExpirationFilter) return false;
  ...
  @override
  String toString() {
    return 'ProductExpirationFilter(accountCode: $accountCode, '
