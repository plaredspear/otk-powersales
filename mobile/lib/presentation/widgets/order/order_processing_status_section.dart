...
class OrderProcessingStatusSection extends StatelessWidget {
  ...
  ///
  /// DefaultReason 라인은 코드 분류에 따라 서버가 결품셋(OUT_OF_STOCK, {F1,L1,L2,L3}) / 취소셋(CANCELLED,
  /// {L4,O1,S1,S2,S3})으로 내려주며, 각각 '미납' / '취소' 로 표기한다(분리는 2026-07-23, 결품셋 표기를
  /// '미납' 으로 환원한 것은 2026-07-25 사용자 결정). displayName 매핑을 그대로 쓰므로 override 불필요.
