...
class InspectionDetailModel {
  ...
  factory InspectionDetailModel.fromJson(Map<String, dynamic> json) {
    return InspectionDetailModel(
      ...
      competitorTasting: json['competitor_tasting'] as bool?,
      competitorProductName: json['competitor_product_name'] as String?,
      competitorProductPrice: json['competitor_product_price'] as int?,
      competitorSalesQuantity: json['competitor_sales_quantity'] as int?,
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      if (competitorTasting != null) 'competitor_tasting': competitorTasting,
      if (competitorProductName != null)
        'competitor_product_name': competitorProductName,
      if (competitorProductPrice != null)
        'competitor_product_price': competitorProductPrice,
      if (competitorSalesQuantity != null)
        'competitor_sales_quantity': competitorSalesQuantity,
