...
/// 유통기한 등록 API 요청 모델
///
/// POST /api/v1/product-expiration 요청 바디를 snake_case JSON으로 직렬화합니다.
class ProductExpirationRegisterRequest {
  ...
  const ProductExpirationRegisterRequest({
  ...
  /// Domain Form에서 생성
  factory ProductExpirationRegisterRequest.fromForm(ProductExpirationRegisterForm form) {
    return ProductExpirationRegisterRequest(
  ...
  bool operator ==(Object other) {
    ...
    if (other is! ProductExpirationRegisterRequest) return false;
  ...
  @override
  String toString() {
    return 'ProductExpirationRegisterRequest(accountCode: $accountCode, '
