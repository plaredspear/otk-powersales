...
class PosSalesMockData {
  ...
  /// 특정 매장의 데이터만 필터링
  static List<PosSales> getByAccountName(String accountName) {
    return data.where((sales) => sales.accountName == accountName).toList();
  }
