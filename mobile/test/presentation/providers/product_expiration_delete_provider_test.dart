...
import 'package:mobile/presentation/providers/product_expiration_delete_provider.dart';

void main() {
  group('ProductExpirationDeleteNotifier', () {
    late ProductExpirationDeleteNotifier notifier;
    ...
    setUp(() {
      ...
      useCase = DeleteProductExpirationBatch(fakeRepository);
      notifier = ProductExpirationDeleteNotifier(deleteBatch: useCase);
    });
...
final _expiredItem1 = ProductExpirationItem(
  seq: 1,
  productCode: 'P001',
  productName: '진라면',
  accountName: '이마트',
...
final _expiredItem2 = ProductExpirationItem(
  seq: 2,
  productCode: 'P002',
  productName: '케첩',
  accountName: '이마트',
...
final _activeItem1 = ProductExpirationItem(
  seq: 3,
  productCode: 'P003',
  productName: '카레',
  accountName: '이마트',
...
final _activeItem2 = ProductExpirationItem(
  seq: 4,
  productCode: 'P004',
  productName: '마요네즈',
  accountName: '이마트',
