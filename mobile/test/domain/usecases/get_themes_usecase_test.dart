...
void main() {
  ...
  late GetThemesUseCase useCase;

  setUp(() {
    repository = _MockInspectionRepository();
    useCase = GetThemesUseCase(repository);
  });

  group('GetThemesUseCase', () {
    test('테마 목록을 조회한다', () async {
      // Given
      ...
      repository.themesResult = expectedThemes;
    ...
    test('빈 테마 목록이 반환될 수 있다', () async {
      // Given
      repository.themesResult = [];
