...
|----------------|------|-------------|
| 스펙 작성/설계/기획, Feature 문서화, `/spec` 명령어 | **스펙 작성** | `.claude/guides/spec-mode.md` 읽기 |
| 구현/개발/코드 작성/테스트/수정/버그, `/impl` 명령어 | **구현** | `.claude/guides/impl-mode.md` 읽기 |

### 모드별 역할

- **스펙 작성 모드**: 기획 내용을 SDD 원칙에 따라 플랫폼별 스펙 문서로 변환. 승인 프로세스 진행. Part 분할 계획 수립.
...
| 문서 | 경로 | 모드 |
|------|------|------|
| 스펙 작성 가이드 | `.claude/guides/spec-mode.md` | 스펙 작성 |
